     ...
     <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#66CCFF" bgcolor="#FFFFFF" >
      ...
      <tr>
				 ...
				 else
	   {
        ...
        <td><a href="upd_title.php?bbs_ID=<?php echo $info1['bbs_ID']; ?>"><img src="images/write.gif" width="16" height="16"></a></td>
        <td><a href="del_title.php?bbs_ID=<?php echo $info1['bbs_ID']; ?>"><img src="images/dele.gif" width="16" height="16"></a></td>
      </tr>
          <?php
	}	
?>
