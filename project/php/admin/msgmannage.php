...
<head>
    ...
    <link rel="stylesheet" href="../../css/php_css/msgmaanage.css">
</head>
    ...
    <div id="content">
        ...
        <div id="content_right">
            ...
            <p align=center class="a-items">
                ...
                <a href="msgmannage.php">首页</a>
                <a href="msgmannage.php?page=<?php echo $page - 1; ?>">上一页</a>
                <a href="msgmannage.php?page=<?php echo $page + 1; ?>">下一页</a>
                <a href="msgmannage.php?page=<?php echo $totalPage; ?>">尾页</a>
            </p>
